...
const Article: ActivityComponentType<ArticleParams> = () => {
  ...
  const appBarLeft = () => <div>Woolston</div>;

  return (
    <Layout appBar={{ renderLeft: appBarLeft }}>
      <div className={css.container}>
        ...
        <div className={css.content}>
          ...
          <div className={css.body}>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean elementum sit sem ullamcorper urna, lacinia
            eu tortor, mattis. Venenatis ut cursus amet in.
          </div>
